    ...
    <div className="min-h-screen flex items-center justify-center bg-black px-6 text-[#fafafa] relative overflow-hidden font-sans">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-medium tracking-tight text-white mb-2">Create your account</h1>
        ...
        <div className="bg-[#0A0A0A] border border-white/10 rounded-2xl p-8 shadow-[0_0_80px_rgba(0,0,0,0.8)] relative">
          ...
          <form action={registerUser} onSubmit={() => setIsSubmitting(true)}>
            <div className="mb-5">
            ...
            <div className="mb-8">
              <label className="flex items-center justify-between text-[13px] font-medium text-[#a3a3a3] mb-2 cursor-pointer">
                <span>Password</span>
